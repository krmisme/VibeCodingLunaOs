...
.system:
 ...
 cmp ax, KERNEL_SERVICE_SYSTEM_network
 je .system_network
...
.system_network:
 ...
 xor r8, r8
 movzx eax, byte [driver_nic_i82540em_ipv4_address]
 mov r8b, al
 movzx eax, byte [driver_nic_i82540em_ipv4_address + 1]
 shl eax, 8
 or r8d, eax
 movzx eax, byte [driver_nic_i82540em_ipv4_address + 2]
 shl eax, 16
 or r8d, eax
 movzx eax, byte [driver_nic_i82540em_ipv4_address + 3]
 shl rax, 24
 or r8, rax
